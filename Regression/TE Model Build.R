...
########## TE MODEL ##########
data = na.omit(TE) # put different position here 
...
### Injury Interaction
Reg <- lm(FantasyPoints ~ FantasyPointsMean_Rolling*TEInjured, data=train)
summary(Reg)

Reg <- lm(FantasyPoints ~ FantasyPointsMean_Last5*TEInjured, data=train)
summary(Reg)

Reg <- lm(FantasyPoints ~ FantasyPointsMean_Last3*TEInjured, data=train)
summary(Reg)

Reg <- lm(FantasyPoints ~ TargetShareMean_Rolling*TEInjured, data=train)
summary(Reg)

Reg <- lm(FantasyPoints ~ TargetShareMean_Last5*TEInjured, data=train)
summary(Reg)
...
Reg <- lm(FantasyPoints ~ FantasyPointsMean_Rolling + TargetShareMean_Rolling + OPR, data=train)
summary(Reg)
evaluate(Reg)
...
# Add OPR
Reg <- lm(FantasyPoints ~ FantasyPointsMean_Last3 + TargetShareMean_Rolling + OPR, data=train)
summary(Reg) # Not Sig
evaluate(Reg)

# Add Injuries
Reg <- lm(FantasyPoints ~ FantasyPointsMean_Last3 + TargetShareMean_Rolling + QBInjured, data=train)
summary(Reg) # Sig
evaluate(Reg) 

Reg <- lm(FantasyPoints ~ FantasyPointsMean_Last3 + TargetShareMean_Rolling + RBInjured, data=train)
summary(Reg) # Not Sig
evaluate(Reg) 

Reg <- lm(FantasyPoints ~ FantasyPointsMean_Last3 + TargetShareMean_Rolling + WRInjured, data=train)
summary(Reg) # Not Sig
evaluate(Reg) 

Reg <- lm(FantasyPoints ~ FantasyPointsMean_Last3 + TargetShareMean_Rolling + TEInjured, data=train)
summary(Reg) # Not Sig
evaluate(Reg) 
...
Reg <- lm(FantasyPoints ~ FantasyPointsMean_Last3 + TargetShareMean_Rolling + QBInjured + OPR, data=train)
summary(Reg)

# Does this model perform better with Random Forest?
Forest <- randomForest(FantasyPoints ~ FantasyPointsMean_Last3 + TargetShareMean_Rolling + QBInjured, data=train, importance=TRUE, ntree=1000, do.trace=50)
Forest
evaluate(Forest) # No

# Does this model perform better with Gradient Boosting?
Boost <- gbm(FantasyPoints ~ FantasyPointsMean_Last3 + TargetShareMean_Rolling + QBInjured, data=train, n.trees=1000)
summary(Boost)
evaluate(Boost) # No
...
# Only FantasyPoints, TargetShares, OPR, QBInjured, TEInjured
Forest <- randomForest(FantasyPoints ~ FantasyPointsMean_Rolling + TargetShareMean_Rolling + FantasyPointsMean_Last5 + TargetShareMean_Last5 + FantasyPointsMean_Last3 + TargetShareMean_Last3 + OPR + QBInjured + TEInjured, data=train, importance=TRUE, ntree=1000, do.trace=50)
Forest
evaluate(Forest) # Not better than regression

Boost <- gbm(FantasyPoints ~ FantasyPointsMean_Rolling + TargetShareMean_Rolling + FantasyPointsMean_Last5 + TargetShareMean_Last5 + FantasyPointsMean_Last3 + TargetShareMean_Last3 + OPR + QBInjured + TEInjured, data=train, n.trees=1000)
summary(Boost)
evaluate(Boost) # Not better than regression

Boost <- gbm(FantasyPoints ~ FantasyPointsMean_Rolling + TargetShareMean_Rolling + FantasyPointsMean_Last5 + TargetShareMean_Last5 + FantasyPointsMean_Last3 + TargetShareMean_Last3 + OPR + QBInjured + TEInjured, data=train, n.trees=10000)
summary(Boost)
evaluate(Boost) # Not better than regression
...
library(stargazer)
stargazer(Reg, type='html', title='TE Regression Model')
...
write.csv(data, "~/Desktop/MGSC 434 Final Project/Optimization Data/TE2021.csv")
